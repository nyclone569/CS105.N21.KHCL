...
void CLineView::OnDraw(CDC* pDC)
{
	...
	Elip elip;
	CFill cfill;
	elip.ElipBresenham(pDC, 150, 150, 30, 40, RGB(0, 255, 150));
	cfill.BoundaryFill(pDC, 150, 150, RGB(255, 150, 200), RGB(0, 255, 150));

	elip.ElipMidPoint(pDC, 500, 150, 45, 35, RGB(0, 255, 0));
	cfill.BoundaryFillEnhanced(pDC, 500, 150, RGB(150, 250, 255));
}
